        ...
        execute: function() {
            KairosDBQueryCtrl = (function (_super) {
                ...
                function KairosDBQueryCtrl($scope, $injector) {
                    ...
                    this.datasource.initialize().then(function () { return $scope.$apply(); });
                    ...
                    this.initializeTags(this.target.query.metricName, $scope);
                }
                ...
                KairosDBQueryCtrl.prototype.onMetricNameChanged = function (newMetricName, oldMetricName, $scope) {
                    ...
                    this.initializeTags(newMetricName, $scope);
                };
                ...
                KairosDBQueryCtrl.prototype.initializeTags = function (metricName, $scope) {
                    var _this = this;
                    this.clear();
                    if (metricName) {
